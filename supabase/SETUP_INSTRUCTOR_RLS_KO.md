...
1. SQL Editor에서 `supabase/migrations/20260524120000_instructor_notices.sql` 실행
2. 없어도 복사·카톡 공유는 사용 가능 (저장·최근 목록만 비활성)

공지는 팔로워·수강생에게 **자동 발송되지 않습니다**. 강사가 카톡·단톡 등에 직접 붙여넣기 합니다.
