...
const GENRES = ['바차타', '살사', '키좀바', '쥬크', '현대무용', '힙합', '걸스힙합', '코레오']
          ...
          <motion.div key="step1" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} transition={{ duration: 0.2 }} style={{ padding: '30px 25px' }}>
            <div style={{ marginBottom: '32px' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: '8px' }}>
                ...
                <span style={{ fontSize: '10px', fontWeight: 900, color: '#C9A84C', letterSpacing: '2px' }}>STEP 01</span>
              </div>
              <h2 style={{ fontSize: '28px', fontWeight: 950, color: '#FFF', margin: '0 0 8px 0', letterSpacing: '-1px' }}>Who are you?</h2>
              <p style={{ fontSize: '14px', color: '#8E8E93', fontWeight: 500 }}>당신의 멋진 예술가적 이름을 알려주세요.</p>
            </div>
            
            <div style={{ marginBottom: '25px' }}>
              <label style={{ display: 'block', fontSize: '11px', fontWeight: 900, color: '#C9A84C', textTransform: 'uppercase', marginBottom: '10px', letterSpacing: '1.5px' }}>Full Name / Stage Name</label>
              <input 
                type="text" 
                value={localData.name || ''} 
                onChange={e => setLocalData({...localData, name: e.target.value})}
                onBlur={() => syncWithParent()}
                placeholder="예: Amanda Lopez"
            ...
            <div style={{ marginBottom: '25px' }}>
              <label style={{ display: 'block', fontSize: '11px', fontWeight: 900, color: '#C9A84C', textTransform: 'uppercase', marginBottom: '10px', letterSpacing: '1.5px' }}>Unique Handle (@ID)</label>
          ...
          <motion.div key="step2" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} transition={{ duration: 0.2 }} style={{ padding: '30px 25px' }}>
            <div style={{ marginBottom: '32px' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: '8px' }}>
                ...
                <span style={{ fontSize: '10px', fontWeight: 900, color: '#C9A84C', letterSpacing: '2px' }}>STEP 02</span>
              </div>
              <h2 style={{ fontSize: '28px', fontWeight: 950, color: '#FFF', margin: '0 0 8px 0', letterSpacing: '-1px' }}>Expertise</h2>
              <p style={{ fontSize: '14px', color: '#8E8E93', fontWeight: 500 }}>주력 장르와 경력을 선택해주세요.</p>
            </div>

            <div style={{ marginBottom: '25px' }}>
              <label style={{ display: 'block', fontSize: '11px', fontWeight: 900, color: '#C9A84C', textTransform: 'uppercase', marginBottom: '15px', letterSpacing: '1.5px' }}>Primary Genres</label>
            ...
            <div style={{ marginBottom: '25px' }}>
              <label style={{ display: 'block', fontSize: '11px', fontWeight: 900, color: '#C9A84C', textTransform: 'uppercase', marginBottom: '10px', letterSpacing: '1.5px' }}>Years of Experience</label>
              <input 
                type="text" 
                value={localData.experience || ''} 
                onChange={e => setLocalData({...localData, experience: e.target.value})}
                onBlur={() => syncWithParent()}
                placeholder="예: 10 Years+"
                style={{ width: '100%', background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: '18px', padding: '20px', color: '#FFF', fontSize: '16px', fontWeight: 600, outline: 'none', boxShadow: 'inset 0 2px 10px rgba(0,0,0,0.5)' }}
              />
            </div>
          </motion.div>
          ...
          <motion.div key="step3" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} transition={{ duration: 0.2 }} style={{ padding: '30px 25px' }}>
            <div style={{ marginBottom: '32px' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: '8px' }}>
                ...
                <span style={{ fontSize: '10px', fontWeight: 900, color: '#C9A84C', letterSpacing: '2px' }}>STEP 03</span>
              </div>
              <h2 style={{ fontSize: '28px', fontWeight: 950, color: '#FFF', margin: '0 0 8px 0', letterSpacing: '-1px' }}>Connectivity</h2>
              <p style={{ fontSize: '14px', color: '#8E8E93', fontWeight: 500 }}>주요 활동 지역과 SNS를 알려주세요.</p>
            </div>

            <div style={{ marginBottom: '25px' }}>
              <label style={{ display: 'block', fontSize: '11px', fontWeight: 900, color: '#C9A84C', textTransform: 'uppercase', marginBottom: '15px', letterSpacing: '1.5px' }}>Main City</label>
            ...
            <div style={{ marginBottom: '25px' }}>
              <label style={{ display: 'block', fontSize: '11px', fontWeight: 900, color: '#C9A84C', textTransform: 'uppercase', marginBottom: '10px', letterSpacing: '1.5px' }}>Instagram Username</label>
              <div style={{ position: 'relative' }}>
          ...
          <motion.div key="step4" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} transition={{ duration: 0.2 }} style={{ padding: '30px 25px' }}>
            <div style={{ marginBottom: '32px' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: '8px' }}>
                ...
                <span style={{ fontSize: '10px', fontWeight: 900, color: '#C9A84C', letterSpacing: '2px' }}>STEP 04</span>
              </div>
              <h2 style={{ fontSize: '28px', fontWeight: 950, color: '#FFF', margin: '0 0 8px 0', letterSpacing: '-1px' }}>Media & Booking</h2>
              <p style={{ fontSize: '14px', color: '#8E8E93', fontWeight: 500 }}>프로필 사진과 예약 링크를 등록해주세요.</p>
            </div>

            <div style={{ marginBottom: '25px' }}>
              <label style={{ display: 'block', fontSize: '11px', fontWeight: 900, color: '#C9A84C', textTransform: 'uppercase', marginBottom: '12px', letterSpacing: '1.5px' }}>Profile Photo Upload</label>
                  ...
                  <div style={{ width: '100px', height: '100px', borderRadius: '30px', background: 'rgba(255,255,255,0.03)', border: '2px dashed rgba(201,168,76,0.3)', overflow: 'hidden', display: 'flex', alignItems: 'center', justifyContent: 'center', boxShadow: '0 10px 20px rgba(0,0,0,0.3)', transition: 'all 0.3s' }}>
                    {preview || localData.photo_url ? (
                      ...
                      <div style={{ textAlign: 'center' }}>
                        ...
                        <div style={{ fontSize: '9px', color: '#C9A84C', fontWeight: 900, marginTop: '4px' }}>UPLOAD</div>
                      </div>
                    )}
                  </div>
                </label>
            ...
            <div style={{ marginBottom: '25px' }}>
              <label style={{ display: 'block', fontSize: '11px', fontWeight: 900, color: '#C9A84C', textTransform: 'uppercase', marginBottom: '10px', letterSpacing: '1.5px' }}>Kakao Open Chat Link</label>
              <div style={{ position: 'relative' }}>
          ...
          <motion.div key="step5" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} transition={{ duration: 0.2 }} style={{ padding: '30px 25px' }}>
            <div style={{ marginBottom: '32px' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: '8px' }}>
                ...
                <span style={{ fontSize: '10px', fontWeight: 900, color: '#C9A84C', letterSpacing: '2px' }}>STEP 05</span>
              </div>
              <h2 style={{ fontSize: '28px', fontWeight: 950, color: '#FFF', margin: '0 0 8px 0', letterSpacing: '-1px' }}>Artistry</h2>
              <p style={{ fontSize: '14px', color: '#8E8E93', fontWeight: 500 }}>당신을 표현하는 한 문장을 적어주세요.</p>
            </div>

            <div style={{ marginBottom: '25px' }}>
              <label style={{ display: 'block', fontSize: '11px', fontWeight: 900, color: '#C9A84C', textTransform: 'uppercase', marginBottom: '10px', letterSpacing: '1.5px' }}>Short Biography</label>
              <textarea 
                value={localData.bio || ''} 
            ...
            <div style={{ 
              ...
              <div style={{ fontSize: '11px', fontWeight: 900, color: '#C9A84C', marginBottom: '15px', letterSpacing: '1px' }}>FINAL REVIEW</div>
              <div style={{ display: 'flex', gap: '18px', alignItems: 'center' }}>
                ...
                <div>
                  <div style={{ fontSize: '18px', fontWeight: 900, color: '#FFF' }}>{localData.name || 'Your Name'}</div>
    ...
    <div style={{ position: 'fixed', inset: 0, zIndex: 10000, display: 'flex', alignItems: 'flex-end', justifyContent: 'center' }}>
      ...
      >
        ...
        <div style={{ padding: '30px 25px 15px', borderBottom: '1px solid rgba(255,255,255,0.05)', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          ...
          <div style={{ textAlign: 'center' }}>
            <span style={{ fontSize: '13px', fontWeight: 900, color: '#FFF', letterSpacing: '2px' }}>MASTER APPLICATION</span>
          </div>
        ...
        <div style={{ padding: '20px 25px 45px', borderTop: '1px solid rgba(255,255,255,0.05)', display: 'flex', gap: '15px', position: 'relative' }}>
          ...
          >
            {loading ? 'PROCESSING...' : (step === TOTAL_STEPS ? 'SUBMIT APPLICATION' : 'NEXT STEP')}
