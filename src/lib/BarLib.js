...
export const BAR_DATABASE = [
  ...
  { name: '꼼애야 2차', name_en: 'Come Ya', address: '서울특별시 마포구 동교로 209-4', region: '서울' },
  ...
  { name: '바이라모스', name_en: 'Baila Ramos', address: '경기도 성남시 분당구 수내동 19-3 대덕프라자 509호', region: '경기도' },
  ...
  { name: '라틴크루', name_en: 'Latin Crew', address: '경기도 안산시 상록구 석바위로 49-1', region: '경기도' },
  ...
  { name: '천안틴', name_en: 'Cheonan Turn', address: '천안시 원두정9길 3 B1', region: '충청도', aliases: ['천안턴'] },
