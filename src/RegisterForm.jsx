  ...
  if (submitted) {
    return (
      <div style={{ textAlign: 'center', padding: '100px 24px', backgroundColor: 'white', minHeight: '100vh', overflowY: 'auto' }}>
        <div style={{ backgroundColor: '#FF1744', width: '80px', height: '80px', borderRadius: '40px', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 32px', boxShadow: '0 10px 25px rgba(255, 23, 68, 0.2)' }}><Check size={40} color="white" /></div>
        ...
        <button onClick={onSuccess || onBack} style={{ width: '100%', padding: '20px', background: '#FF1744', color: 'white', borderRadius: '16px', fontWeight: 800, fontSize: '18px', boxShadow: '0 4px 12px rgba(0,0,0,0.1)' }}>확인</button>
      </div>
    )
  }
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '8px', marginBottom: '12px' }}>
            {['매너 음료', '10,000원', '12,000원', '15,000원', '18,000원', '20,000원', '25,000원', '기타'].map(fee => (
              <button
                ...
                style={{ 
                  padding: '10px 4px', 
                  backgroundColor: formData.fee === fee ? '#FF1744' : '#F3F4F6', 
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '8px' }}>
            {['서울', '경기도', '인천광역시', '경상도', '전라도', '충청도', '강원도', '제주도'].map(r => (
              <button
                ...
                style={{
                  padding: '10px 4px',
                  backgroundColor: formData.region === r ? '#FF1744' : '#F3F4F6',
        ...
        <div style={{ marginBottom: '24px', backgroundColor: '#F9FAFB', padding: '16px', borderRadius: '16px' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '4px', alignItems: 'center' }}>
            ...
            <div style={{ textAlign: 'center' }}>
              <span style={{ fontSize: '12px', fontWeight: 900, color: '#FF1744', display: 'block', marginBottom: '8px' }}>B</span>
              <div style={{ display:'flex', flexDirection: 'column', alignItems:'center', justifyContent:'center', gap:'6px' }}>
                ...
                >▲</button>
                <span style={{ fontSize:'20px', fontWeight:900, color:'#FF1744' }}>{formData.bRatio}</span>
                <button 
                  type="button"
            ...
            {/* S (Salsa) */}
            <div style={{ textAlign: 'center' }}>
              <span style={{ fontSize: '12px', fontWeight: 900, color: '#FF1744', display: 'block', marginBottom: '8px' }}>S</span>
              <div style={{ display:'flex', flexDirection: 'column', alignItems:'center', justifyContent:'center', gap:'6px' }}>
                <button
                  type="button"
                  ...
                  style={{ width:'100%', padding: '6px 0', borderRadius:'8px', border:'1px solid #ddd', background:'#fff', fontSize:'12px', cursor:'pointer' }}
                >▲</button>
                <span style={{ fontSize:'20px', fontWeight:900, color:'#FF1744' }}>{formData.sRatio}</span>
                <button 
                  type="button"
            ...
            {/* J (Zouk) */}
            <div style={{ textAlign: 'center' }}>
              <span style={{ fontSize: '12px', fontWeight: 900, color: '#FF1744', display: 'block', marginBottom: '8px' }}>J</span>
              <div style={{ display:'flex', flexDirection: 'column', alignItems:'center', justifyContent:'center', gap:'6px' }}>
                <button
                  type="button"
                  ...
                  style={{ width:'100%', padding: '6px 0', borderRadius:'8px', border:'1px solid #ddd', background:'#fff', fontSize:'12px', cursor:'pointer' }}
                >▲</button>
                <span style={{ fontSize:'20px', fontWeight:900, color:'#FF1744' }}>{formData.jRatio}</span>
                <button 
                  type="button"
            ...
            {/* K (Kizomba) */}
            <div style={{ textAlign: 'center' }}>
              <span style={{ fontSize: '12px', fontWeight: 900, color: '#FF1744', display: 'block', marginBottom: '8px' }}>K</span>
              <div style={{ display:'flex', flexDirection: 'column', alignItems:'center', justifyContent:'center', gap:'6px' }}>
                <button
                  type="button"
                  ...
                  style={{ width:'100%', padding: '6px 0', borderRadius:'8px', border:'1px solid #ddd', background:'#fff', fontSize:'12px', cursor:'pointer' }}
                >▲</button>
                <span style={{ fontSize:'20px', fontWeight:900, color:'#FF1744' }}>{formData.kRatio}</span>
                <button 
                  type="button"
