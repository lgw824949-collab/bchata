  ...
  */
  ...
  const StatCard = ({ label, value, icon }) => (
    <div style={{
      ...
      <div style={{ fontSize: '12px', fontWeight: 900, color: '#FFF', textAlign: 'center', lineHeight: 1.3 }}>{value || '-'}</div>
        ...
        <div style={{ position: 'relative' }}>
          ...
          <input
            ...
            style={{
              width: '100%', padding: '12px 15px 12px 42px', borderRadius: '16px',
              background: 'rgba(255,255,255,0.05)', border: '1px solid rgba(255,255,255,0.1)',
              color: '#FFF', fontSize: '14px', fontWeight: 600, outline: 'none', boxSizing: 'border-box'
            }}
          />
        </div>
        ...
        {loading ? (
          ...
          <>
            {(isFiltering
              ...
              >
                <div style={{ width: 60, height: 60, borderRadius: '16px', overflow: 'hidden', background: '#1A1A1A', border: '1px solid rgba(255,255,255,0.05)', flexShrink: 0 }}>
                  {item.poster_url
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  <div style={{ fontSize: 17, fontWeight: 900, color: '#FFF', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>{item.instructor}</div>
