...
const desc = [
  ...
  '            }}',
  '          >',
  "            <motion.div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 8 }}>",
].join('\n');

// rebuild without typos
const descBlock = [
  '          <div',
  '            style={{',
  '              marginTop: 12,',
...
s = s.slice(0, i0) + descBlock + '\n\n' + scheduleBlock + '\n\n' + oldEnd.replace('otherDates.length > 0 ? 0 : 4', '4') + s.slice(i1 + oldEnd.length);
